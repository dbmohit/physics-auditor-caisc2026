...
End-to-end AI scientist systems close the loop from hypothesis generation
through code execution to write-up and peer review, yet none implement
domain-specific physical consistency checks on their outputs.
...
any reviewer can reproduce the main results in under two minutes on a
standard laptop. Code and data:
\url{https://github.com/dbmohit/physics-auditor-caisc2026}.
\end{abstract}
...
\begin{enumerate}
  ...
  \item The Physics Auditor agent: a single-file, CPU-only, 0.11-second
    ...
    own outputs. Code and data are publicly available at
    \url{https://github.com/dbmohit/physics-auditor-caisc2026}.
\end{enumerate}
